...
const form = useForm({
    ...
    subject_setup: convertToBoolean(props.permissions?.subject_setup),
    ...
    // madrasa_misc:props.admin.madrasa_misc || false,
...
const submit = () => {
    form.put(route('user_create_for_admin.update', props.admin.id), {
        onError: (e) => {
            errors.value = e;
        }
    });
