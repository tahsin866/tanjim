            ...
            <div class="col-span-12">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div class="field">
                    ...
                    <div class="flex flex-col items-center">
                      <div class="mb-3">
                        <Avatar
                          :image="photoPreview || getPhotoUrl(form.photo)"
                          size="xlarge"
                          shape="circle"
              ...
              >
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <!-- Helpful hint -->
                  <div
                    class="md:col-span-2 mb-3 p-2 bg-blue-50 border border-blue-200 rounded text-xs text-blue-700"
                  >
                    <svg
                    ...
                    টিপস: ইংরেজি সন নির্বাচন করলে স্বয়ংক্রিয়ভাবে হিজরি সন
                    নির্বাচিত হবে এবং বিপরীতভাবেও।
                  </div>
                  <!-- তাকমিল -->
                  <div class="border rounded-lg p-4">
                    ...
                    <div
                      v-if="form.dept_takmil"
                      class="grid grid-cols-2 gap-4 ml-6"
                    >
                      <div>
                  ...
                  <div class="border rounded-lg p-4">
                    ...
                    >
                      <div>
                        ...
                        >
                        <select
                          v-model="form.dept_adab_year_english"
                          @change="
                            handleEnglishYearChange(
                              form.dept_adab_year_english,
                              'adab'
                            )
                          "
                          class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                      ...
                      <div>
                        ...
                        >
                        <select
                          v-model="form.dept_adab_year_hijri"
                          @change="
                            handleHijriYearChange(
                              form.dept_adab_year_hijri,
                              'adab'
                            )
                          "
                          class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                  ...
                  <div class="border rounded-lg p-4">
                    <div class="flex items-center mb-3">
                      <input
                        type="checkbox"
                        id="dept_other"
                        v-model="form.dept_other"
                        class="mr-3 h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded"
                      />
                      <label
                        for="dept_other"
                        class="text-sm font-medium text-gray-700"
                        >অন্যান্য বিভাগ</label
                      >
                    </div>
                    <div
                      v-if="form.dept_other"
                      class="grid grid-cols-1 gap-4 ml-6"
                    >
                      <div>
                        <label class="text-sm font-medium text-gray-700"
                          >ক্লাস</label
              ...
              <Fieldset
                legend="পরীক্ষা ও অন্যান্য তথ্য"
                :toggleable="true"
                class="border border-gray-200 rounded-lg shadow-sm mb-4"
              >
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div class="field" v-if="form.idType === 'birth'">
                    ...
                    <div class="mt-4">
                      <label
                        ...
                        >জন্মনিবন্ধন কার্ড/সার্টিফিকেটের ছবি</label
                      >
                      <div class="flex flex-col items-center">
                  ...
                  <div class="field" v-if="form.idType === 'voter'">
                    ...
                    <div class="mt-4">
                      <label
                        class="block text-sm font-medium text-gray-700 mb-2"
                        >ভোটার আইডি কার্ডের ছবি</label
                      >
                      <div class="flex flex-col items-center">
                        <!-- Current Image Display -->
                        <div
                          v-if="voterIdPreview || getVoterIdPhotoUrl()"
                          class="mb-3"
                        >
                          <img
                            :src="voterIdPreview || getVoterIdPhotoUrl()"
                        ...
                        >
                          {{
                            voterIdPreview || getVoterIdPhotoUrl()
                              ? "ছবি পরিবর্তন করুন"
                              : "ছবি আপলোড করুন"
                          }}
                        </Button>
                  ...
                  <div class="field" v-if="form.idType === 'passport'">
                    <label
                      for="passportId"
                      class="block text-sm font-medium text-gray-700 mb-1"
                      >পাসপোর্ট নম্বর</label
                    >
                    <InputText
                      id="passportId"
                    ...
                    <div class="mt-4">
                      <label
                        class="block text-sm font-medium text-gray-700 mb-2"
                        >পাসপোর্টের ছবি</label
                      >
                      <div class="flex flex-col items-center">
                        <!-- Current Image Display -->
                        <div
                          v-if="passportPreview || getPassportPhotoUrl()"
                          class="mb-3"
                        >
                          <img
                            :src="passportPreview || getPassportPhotoUrl()"
                            alt="পাসপোর্ট"
                            class="w-32 h-24 object-cover border-2 border-gray-200 rounded-lg shadow-md"
                          />
                        </div>
                        ...
                        <input
                          type="file"
                          ref="passportInput"
                          @change="handlePassportPhotoChange"
                          accept="image/*"
                          class="hidden"
                        />
                        <Button
                        ...
                        >
                          {{
                            passportPreview || getPassportPhotoUrl()
                              ? "ছবি পরিবর্তন করুন"
                              : "ছবি আপলোড করুন"
                          }}
                        </Button>
    ...
    if (newStudent) {
      ...
      if (newStudent.information) {
        form.alternatePhoneNumber =
          newStudent.information.alternatePhoneNumber || "";
        ...
        form.dept_adab = newStudent.information.dept_adab || false;
        form.dept_other = newStudent.information.dept_other || false;
        form.dept_other_class = newStudent.information.dept_other_class || "";
        form.dept_takmil_year_english =
          newStudent.information.dept_takmil_year_english || "";
        form.dept_takmil_year_hijri =
          newStudent.information.dept_takmil_year_hijri || "";
        form.dept_ifta_year_english =
          newStudent.information.dept_ifta_year_english || "";
        form.dept_ifta_year_hijri =
          newStudent.information.dept_ifta_year_hijri || "";
        form.dept_hifz_year_english =
          newStudent.information.dept_hifz_year_english || "";
        form.dept_hifz_year_hijri =
          newStudent.information.dept_hifz_year_hijri || "";
        form.dept_qirat_year_english =
          newStudent.information.dept_qirat_year_english || "";
        form.dept_qirat_year_hijri =
          newStudent.information.dept_qirat_year_hijri || "";
        form.dept_adab_year_english =
          newStudent.information.dept_adab_year_english || "";
        form.dept_adab_year_hijri =
          newStudent.information.dept_adab_year_hijri || "";
        ...
        form.passportId = newStudent.information.passportId || "";
        form.birthCertificatePhoto =
          newStudent.information.birthCertificatePhoto || null;
        form.voterIdPhoto = newStudent.information.voterIdPhoto || null;
        form.passportPhoto = newStudent.information.passportPhoto || null;
...
const syncHijriFromEnglish = (englishYear, department) => {
  const yearData = sessionYears.value.find(
    (year) => year.english_year == englishYear
  );
  if (yearData) {
...
const syncEnglishFromHijri = (hijriYear, department) => {
  const yearData = sessionYears.value.find(
    (year) => year.hijri_year === hijriYear
  );
  if (yearData) {
...
function handlePassportPhotoChange(e) {
  const file = e.target.files[0];
  if (file) {
    form.passportPhoto = file;
    const reader = new FileReader();
    reader.onload = (event) => {
      passportPreview.value = event.target.result;
    };
    reader.readAsDataURL(file);
  }
}
...
function getBirthCertificatePhotoUrl() {
  ...
  if (
    typeof form.birthCertificatePhoto === "string" &&
    (form.birthCertificatePhoto.startsWith("http://") ||
      form.birthCertificatePhoto.startsWith("https://"))
  ) {
    return form.birthCertificatePhoto;
  }
  if (
    typeof form.birthCertificatePhoto === "string" &&
    form.birthCertificatePhoto.startsWith("/")
  ) {
    return form.birthCertificatePhoto;
  }
...
function getVoterIdPhotoUrl() {
  ...
  if (
    typeof form.voterIdPhoto === "string" &&
    (form.voterIdPhoto.startsWith("http://") ||
      form.voterIdPhoto.startsWith("https://"))
  ) {
    return form.voterIdPhoto;
  }
  if (
    typeof form.voterIdPhoto === "string" &&
    form.voterIdPhoto.startsWith("/")
  ) {
    return form.voterIdPhoto;
  }
...
function getPassportPhotoUrl() {
  if (!form.passportPhoto) return null;
  if (
    typeof form.passportPhoto === "string" &&
    (form.passportPhoto.startsWith("http://") ||
      form.passportPhoto.startsWith("https://"))
  ) {
    return form.passportPhoto;
  }
  if (
    typeof form.passportPhoto === "string" &&
    form.passportPhoto.startsWith("/")
  ) {
    return form.passportPhoto;
  }
  if (typeof form.passportPhoto === "string") {
    return `/storage/${form.passportPhoto}`;
  }
  return null;
}
