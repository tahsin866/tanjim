    ...
    <div class="min-h-screen flex flex-col justify-center items-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="w-full max-w-md">
            <div class="bg-white rounded-lg shadow-xl overflow-hidden">
                ...
                <div class="px-6 py-8">
                    <div v-if="status" class="mb-6 p-4 bg-emerald-50 rounded-lg border-l-4 border-emerald-500 text-emerald-700 flex items-center">
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    type="email"
                                    v-model="form.email"
                                    class="pl-10 block w-full rounded-md border-emerald-300 focus:border-emerald-500 focus:ring-emerald-500 bg-white shadow-sm font-bangla"
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <Link
                                ...
                                class="text-sm text-emerald-600 hover:text-emerald-700 transition duration-200 font-bangla"
                            >
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="text-sm text-center text-gray-600 mt-6 font-bangla">
                                ...
                                <Link
                                    ...
                                    class="font-medium text-emerald-600 hover:text-emerald-700 transition duration-200 ml-1 font-bangla"
                                >
                                    নিবন্ধন করুন
                                </Link>
                            </div>
