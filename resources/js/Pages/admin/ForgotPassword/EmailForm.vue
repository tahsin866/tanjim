...
<template>
    ...
    >
        <Head title="এডমিন পাসওয়ার্ড ভুলে গেছেন? - WEMS" />
        ...
        <div class="w-full max-w-md bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="text-center px-6 pb-6 border-b border-gray-200">
                <h2 class="text-2xl font-bold text-emerald-800 font-bangla">এডমিন পাসওয়ার্ড ভুলে গেছেন?</h2>
                <p class="text-gray-600 mt-2 font-bangla">আপনার এডমিন ইমেইল ঠিকানা দিন, আমরা আপনাকে একটি OTP পাঠাবো</p>
            </div>
            ...
            <div class="p-6">
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    <!-- Email Field -->
                    <div class="group">
                        <label for="email" class="block text-gray-700 font-medium mb-2 font-bangla">এডমিন ইমেইল ঠিকানা</label>
                        <div class="relative">
                            ...
                            <input
                                ...
                                placeholder="আপনার এডমিন ইমেইল ঠিকানা"
                                required
                                autofocus
                            />
                        </div>
