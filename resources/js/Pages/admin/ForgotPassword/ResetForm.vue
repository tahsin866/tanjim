...
<template>
    ...
    >
        <Head title="এডমিন নতুন পাসওয়ার্ড সেট করুন - WEMS" />
        ...
        <div class="w-full max-w-md bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="text-center px-6 pb-6 border-b border-gray-200">
                <h2 class="text-2xl font-bold text-emerald-800 font-bangla">এডমিন নতুন পাসওয়ার্ড সেট করুন</h2>
            ...
            <div class="p-6">
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="group">
                        ...
                        <p class="mt-1 text-sm text-gray-500 font-bangla">একই পাসওয়ার্ড আবার লিখুন</p>
                    </div>
