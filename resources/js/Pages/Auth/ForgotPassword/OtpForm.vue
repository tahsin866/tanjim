...
const resendOtp = () => {
    ...
    resendForm.post(route('password.resend-otp'), {
        onSuccess: () => {
            startCountdown();
        },
    });
...
const submit = () => {
    if (form.otp.length === 6) {
        form.post(route('password.verify-otp.post'));
    }
};
</script>
...
<template>
    ...
    >
        <Head title="OTP যাচাই করুন - WEMS" />
        ...
        <div class="w-full max-w-md bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="text-center px-6 pb-6 border-b border-gray-200">
                <h2 class="text-2xl font-bold text-emerald-800 font-bangla">OTP যাচাই করুন</h2>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="text-center border-t pt-4">
                        ...
                        >
                            ...
                            <span v-else>নতুন কোড পাঠান</span>
                        </button>
                    </div>
